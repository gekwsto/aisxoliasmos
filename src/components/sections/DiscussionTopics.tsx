...
const topics = [
  {
    id: 1,
    question: 'Θα αντικαταστήσει η AI τους προγραμματιστές;',
    votes: 4812,
    comments: 342,
    hot: true,
  },
  {
    id: 2,
    question: 'Είναι φούσκα το Bitcoin ή το μέλλον του χρήματος;',
    votes: 3901,
    comments: 217,
    hot: true,
  },
  {
    id: 3,
    question: 'Θα αγοράζατε ηλεκτρικό αυτοκίνητο σήμερα;',
    votes: 2744,
    comments: 189,
    hot: false,
  },
  {
    id: 4,
    question: 'Είναι έτοιμη η Ευρώπη για το AI Act;',
    votes: 2103,
    comments: 156,
    hot: false,
  },
  {
    id: 5,
    question: 'Πρέπει η Ελλάδα να επενδύσει περισσότερο σε startups;',
    votes: 1887,
    comments: 124,
    hot: false,
  },
  {
    id: 6,
    question: 'Θα εμπιστευόσασταν AI γιατρό για διάγνωση;',
    votes: 1654,
    comments: 98,
    hot: false,
  },
  {
    id: 7,
    question: 'Work from home ή γραφείο — τι προτιμάτε;',
    votes: 3210,
    comments: 271,
    hot: true,
  },
    ...
    <section className="bg-gradient-to-br from-slate-50 to-blue-50/40 dark:from-slate-800/60 dark:to-slate-800/40 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm">
      ...
      <div className="flex flex-wrap gap-3">
        {topics.map((topic) => (
          <div
            key={topic.id}
            className={`relative group cursor-pointer flex-grow min-w-[200px] max-w-full sm:max-w-[calc(50%-0.375rem)] bg-white dark:bg-slate-800 border rounded-xl px-4 py-3 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md dark:hover:shadow-slate-900/40 ${
              topic.hot
          ...
          >
            ...
            <p className="text-sm font-semibold text-slate-800 dark:text-slate-100 leading-snug group-hover:text-blue-700 dark:group-hover:text-blue-400 transition-colors">
              {topic.question}
            </p>
            ...
            <div className="mt-2 flex items-center gap-3 text-[11px] text-slate-400 dark:text-slate-500">
              <span className="flex items-center gap-1">
                ...
                {formatCount(topic.votes)} ψήφοι
              </span>
              <span className="flex items-center gap-1">
                <MessageCircle size={10} />
                {formatCount(topic.comments)} σχόλια
              </span>
            </div>
          </div>
        ))}
